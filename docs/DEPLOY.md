...
> **Важно:** проектный сайт живёт по пути `/fuel-landing/`. Пути к изображениям и конфигам
> резолвятся через `js/base-path.js` — не используйте абсолютные `/images/...` в коде.
